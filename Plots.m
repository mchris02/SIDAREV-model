...
c_1_a_val_ = 100000;
          ...
          %     title(['Strategy control against time for b2 = ' num2str(b2(i,1))]);
               ...
               load (['c_1_a_' num2str(c_1_a_val_) '_b2_' num2str(b2(2,1)) '_m_' num2str(m(2,1)) '.mat']);
          ...
          %     title(['Strategy control against time for b2 = ' num2str(b2(i,1))]);
               ...
               %saveas(figure(1),['c_1_a_' num2str(c_1_a(i,1)) '_b2_' num2str(b2(j,1)) '_m_'  num2str(m(k,1)) '_U'],'epsc')
               saveas(figure(17),['c_1_a_' num2str(c_1_a_val_) '_b2_' num2str(b2(2,1)) '_m_' num2str(m(2,1)) '_U.jpeg'])
               clf   
